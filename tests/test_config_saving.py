...
def test_partial_config_is_preserved_exactly_across_save_and_load():
    ...
    config = calib.Config()
    config.populate_distortion_from_chessboard('sample_images/002h.bmp', 6, 8)
...
def test_full_config_is_preserved_exactly_across_save_and_load():
    ...
    config = calib.Config()
    config.populate_distortion_from_chessboard('sample_images/002h.bmp', 6, 8)
    config.populate_homography_from_chessboard('sample_images/002h.bmp', 8, 6, 90.06, 64.45)
